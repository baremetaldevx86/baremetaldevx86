...
* **[Autograd Engine](https://github.com/baremetaldevx86/autograd-engine)** – An automatic differentiation engine with tensor ops, backprop, and custom memory handling built in pure C.
